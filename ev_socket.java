...
class EVChargingSystem {
    ...
    private void populateStations() {
        stations.add(new ChargingStation("Station A", "Yendada", 5, "Fast"));
        stations.add(new ChargingStation("Station B", "RK beach", 10,"Normal"));
        stations.add(new ChargingStation("Station C", "MVP", 2, "Fast"));
        stations.add(new ChargingStation("Station D", "Complex", 8, "Normal"));
    }
